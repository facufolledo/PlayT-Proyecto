...
export default function Register() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Siempre redirigir a completar perfil después de registro con Google
      navigate('/completar-perfil');
    } catch (err: any) {
      setErrors({ general: err.message || 'Error al registrarse con Google' });
    }
  };
        ...
        <div className="bg-cardBg rounded-2xl p-8 border border-cardBorder shadow-2xl">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-cardBg text-textSecondary">O regístrate con</span>
            </div>
          </div>
